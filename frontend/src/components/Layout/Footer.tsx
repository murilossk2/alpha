      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-600 text-sm">
              Especialistas em chopeiras e equipamentos para cerveja artesanal.
              Qualidade e excelência em cada produto.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/promotions" className="text-gray-600 hover:text-primary-600 text-sm">
                  Promoções
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li>Email: contato@chopeiras.com</li>
        ...
        <div className="mt-8 border-t border-gray-200 pt-8">
          <p className="text-center text-sm text-gray-400">
            &copy; {new Date().getFullYear()} Chopeiras. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
