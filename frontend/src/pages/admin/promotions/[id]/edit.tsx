...
export default function EditPromotion() {
  ...
  const { register, handleSubmit, reset, formState: { errors } } = useForm<PromotionForm>();
    ...
    },
    {
      ...
      onSuccess: (data) => {
        if (data) {
          ...
          // Atualizar produtos e categorias selecionados
          setSelectedProducts(data.products.map((p: any) => p._id));
          setSelectedCategories(data.categories.map((c: any) => c._id));
        }
      },
    }
  );
